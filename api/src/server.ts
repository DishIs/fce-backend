...
connectToMongo().then(() => {
  ...
  app.use(express.json({
    limit: '1mb', // Increased from default 100kb to handle large Paddle v3 payloads
  ...
  app.get('/user/timeline', require('./handlers/events-handler').getUserTimelineHandler);
  app.get('/user/insights', require('./handlers/events-handler').getUserInsightsHandler);
